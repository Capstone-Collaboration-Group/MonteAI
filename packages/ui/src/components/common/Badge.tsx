...
const variants = {
  ...
  defense: "bg-[#008000]/15 text-[#008000] dark:bg-[#008000]/25 dark:text-[#4CAF50] border-transparent",
...
const dots = { primary: "bg-[#0D7856]", defense: "bg-[#008000]", pending: "bg-[#FFFF00]", critical: "bg-[#FF0000]", surface: "bg-on-surface-variant", outline: "bg-on-surface-variant" };
