...
function Hero() {
  return (
    <section className="flex flex-col items-center justify-center bg-gradient-to-b from-green-50 to-white px-6 py-24">
      <span className="rounded-full border border-green-500 bg-green-200 px-5 py-2 text-sm font-semibold tracking-wide text-green-700 shadow-sm">
        About Us
      </span>
