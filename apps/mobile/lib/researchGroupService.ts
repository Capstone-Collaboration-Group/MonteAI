// apps/mobile/lib/researchGroupService.ts
import { createApiClient, createResearchGroupService } from '@monteai/api';
...
export const researchGroupService = createResearchGroupService(client, useMock);
