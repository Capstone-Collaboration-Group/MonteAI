...
import { LeftPanel, Modal, Card, RegistrationForm } from "@monteai/ui";
import { auth } from "../lib/firebaseServices";
import { authService, profileService } from "../lib/authServices";
        ...
        <Card className="overflow-hidden rounded-[32px] border-none bg-white p-0 shadow-[0_20px_70px_rgba(0,100,0,0.12)]">
          <div className="grid lg:grid-cols-[0.9fr_1.1fr]">
            ...
            <div className="p-6 sm:p-8 lg:p-10">
              <RegistrationForm
                auth={auth}
                register={(dto) => authService.register(dto)}
                checkExistingProfile={() => profileService.getCurrentProfile()}
                onSuccess={() => navigate("/")}
